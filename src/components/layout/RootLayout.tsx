  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-200 overflow-hidden">
      ...
      <div className="flex flex-grow">
        {/* Sidebar Navigation */}
        <nav
          className="bg-gray-300 border-r border-gray-400 flex flex-col overflow-hidden mr-1.5"
        >
        ...
        {/* Main Content */}
        <div className="flex-1 bg-gray-100 overflow-hidden p-2 sm:p-1 md:p-1 lg:p-1 ">
          <Outlet />
        </div>
      </div>
    </div>
